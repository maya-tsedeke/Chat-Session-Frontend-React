...
function SideBarComponent({ open, handleDrawerClose }: SideBarComponentProps) {
  ...
  const menuItems1 = isLoggedIn
    ? [
        { text: 'JSON Data', link: '/data', icon: <DashboardIcon /> },
       { text: 'CommonTable', link: '/table', icon: <ShoppingCartIcon /> },
      ]
    : [
  ...
  const menuItems2 = isLoggedIn
    ...
    : [
        { text: 'Login', link: '/', icon: <LockIcon /> },
        { text: 'Signup', link: '/signup', icon: <CreateIcon /> },
      ];
